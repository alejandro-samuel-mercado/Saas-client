...
export function Marquee() {
    ...
    if (isLoading) {
        return (
            <div className="w-full relative h-16 bg-gradient-to-r from-secondary via-secondary to-secondary animate-pulse" />
        );
    }
    ...
    return (
        <div className="w-full relative overflow-hidden bg-gradient-to-r from-secondary to-primary pointer-events-none">
